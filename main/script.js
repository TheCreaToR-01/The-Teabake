...
const PRODUCTS = [
    ...
    // ITALIAN BREADS
    { id: 'ib1', cat: 'italian-breads', catLabel: 'Italian Breads', name: 'Ciabatta', desc: 'Rustic Italian bread with a crisp, lightly floured crust and an airy, open crumb. Delicate, chewy and perfect for sandwiches.', prices: [{ label: 'Pack of 2', val: '₹280' }], emoji: '🥖', img: 'main/assets/Ciabatta.jpeg', type: "main/assets/veg.png" },
    ...
    // SPECIALTY BREADS
    { id: 'sb1', cat: 'specialty-breads', catLabel: 'Specialty Breads', name: 'Brioche', desc: 'Rich buttery French bread with a tender, pillowy crumb and a delicate golden crust, subtly sweet, luxuriously soft, and beautifully versatile.', prices: [{ label: 'Loaf', val: '₹400' }], emoji: '🥐', img: 'main/assets/Brioche.jpeg', type: "main/assets/veg.png" },
    ...
    { id: 'vi5', cat: 'viennoiserie', catLabel: 'Viennoiserie', name: 'Bagel', desc: 'Hand-rolled and gently boiled before baking for its signature satisfying chew. Dense, chewy, golden — the real thing.', prices: [{ label: 'Pack of 2', val: '₹250' }], emoji: '🥯', img: 'main/assets/Bagel.jpeg', type: "main/assets/veg.png" },
