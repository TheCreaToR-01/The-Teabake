...
const PRODUCTS = [
    ...
    { id: 'tc1', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Date & Fig Walnut', desc: 'A beautifully moist tea cake packed with sweet dates, plump figs, and crunchy walnuts. Slow-baked for a rich, tender crumb. Perfect with your afternoon chai.', prices: [{ label: '½ Kg', val: '₹1,199' }, { label: '1 Kg', val: '₹1,999' }], emoji: '🍰', img: 'https://images.unsplash.com/photo-1602351447937-745cb720612f?w=600&q=80' },
    { id: 'tc2', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Whole Wheat Jaggery Walnut', desc: 'A wholesome loaf made with whole wheat flour and natural jaggery, dotted with walnuts. Earthy, subtly sweet, and utterly satisfying. Guilt-free indulgence at its finest.', prices: [{ label: '½ Kg', val: '₹1,199' }, { label: '1 Kg', val: '₹1,999' }], emoji: '🌾', img: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&q=80' },
    { id: 'tc3', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Banana Loaf', desc: 'Overripe bananas folded into a buttery batter for a supremely moist, fragrant loaf. Golden-crusted on the outside, cloud-soft within. A timeless classic, baked with care.', prices: [{ label: '½ Kg', val: '₹1,199' }, { label: '1 Kg', val: '₹1,999' }], emoji: '🍌', img: 'https://images.unsplash.com/photo-1586444248902-2f64eddc13df?w=600&q=80' },
    { id: 'tc4', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Vanilla Walnut', desc: 'A gentle, aromatic vanilla tea cake studded with toasted walnuts. Soft, fragrant, and unfailingly comforting — the kind of cake that feels like home.', prices: [{ label: '½ Kg', val: '₹1,199' }, { label: '1 Kg', val: '₹1,999' }], emoji: '🍦', img: 'https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?w=600&q=80' },
    { id: 'tc5', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Citrus Cake', desc: 'Bright, zesty, and beautifully fragrant — a sunshine-yellow loaf bursting with orange and lemon. Light-crumbed and refreshing, it pairs perfectly with a pot of tea.', prices: [{ label: '½ Kg', val: '₹1,199' }, { label: '1 Kg', val: '₹1,999' }], emoji: '🍋', img: 'https://images.unsplash.com/photo-1519869325930-281384150729?w=600&q=80' },
    { id: 'tc6', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Dark Chocolate Valencia', desc: 'Rich dark chocolate meets the bright fragrance of Valencia orange in this deeply indulgent loaf. Fudgy, intense, and just slightly bittersweet — a grown-up chocolate cake.', prices: [{ label: '½ Kg', val: '₹1,199' }, { label: '1 Kg', val: '₹1,999' }], emoji: '🍫', img: 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=600&q=80' },
    { id: 'tc7', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Apple Cinnamon Crumble', desc: 'Tender spiced apple pieces folded into a cinnamon-kissed batter, finished with a buttery crumble topping. Warm, cosy, and deeply nostalgic.', prices: [{ label: '½ Kg', val: '₹1,199' }, { label: '1 Kg', val: '₹1,999' }], emoji: '🍎', img: 'https://images.unsplash.com/photo-1568571780765-9276dd3a5838?w=600&q=80' },
    { id: 'tc8', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Lemon Ricotta Almond', desc: 'A delicate Italian-inspired cake where creamy ricotta keeps the crumb impossibly moist, brightened by lemon zest and finished with flaked almonds. Subtle, sophisticated, sublime.', prices: [{ label: '½ Kg', val: '₹1,599' }, { label: '1 Kg', val: '₹2,899' }], emoji: '🍋', img: 'https://images.unsplash.com/photo-1571115177098-24ec42ed204d?w=600&q=80' },
    { id: 'tc9', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Carrot Walnut Cake', desc: 'Spiced carrot cake with warm cinnamon and hints of nutmeg, shredded carrots. Finished with a smooth cream cheese frosting and walnuts.', prices: [{ label: '½ Kg', val: '₹1,399' }, { label: '1 Kg', val: '₹2,799' }], emoji: '🥕', img: 'https://images.unsplash.com/photo-1621303837174-89787a7d4729?w=600&q=80' },
    { id: 'tc10', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Christmas Plum Cake', desc: "Our signature rich cake packed with dried fruits soaked and matured in 'Old Monk' for depth of flavor, walnuts, almonds and a touch of warm spices. Slow baked to achieve a moist and tender crumb.", prices: [{ label: '½ Kg', val: '₹1,599' }, { label: '1 Kg', val: '₹2,999' }], emoji: '🎄', img: 'https://images.unsplash.com/photo-1481391319762-47dff72954d9?w=600&q=80' },

    // SOURDOUGH
    { id: 'sd1', cat: 'sourdough', catLabel: 'Sourdough Loaves', name: 'Country Sourdough', desc: 'Naturally leavened and slow-fermented for depth of flavor, with a crisp artisan crust and an open chewy crumb. Mildly tangy, wholesome and beautifully rustic.', prices: [{ label: 'Loaf', val: '₹350' }], emoji: '🍞', img: 'https://images.unsplash.com/photo-1586444248902-2f64eddc13df?w=600&q=80' },
    { id: 'sd2', cat: 'sourdough', catLabel: 'Sourdough Loaves', name: 'Cranberry & Walnut Sourdough', desc: 'Our classic naturally-leavened sourdough studded with plump dried cranberries and toasted walnuts. Sweet, tangy, and satisfyingly chewy — spectacular with cheese or butter.', prices: [{ label: 'Loaf', val: '₹450' }], emoji: '🍞', img: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&q=80' },
    { id: 'sd3', cat: 'sourdough', catLabel: 'Sourdough Loaves', name: 'Jalapeño & Cheddar Sourdough', desc: 'A bold, savory sourdough with pockets of melted cheddar and the gentle heat of jalapeño peppers throughout. An addictive combination — cheesy, spicy, tangy.', prices: [{ label: 'Loaf', val: '₹450' }], emoji: '🧀', img: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc7c?w=600&q=80' },
    { id: 'sd4', cat: 'sourdough', catLabel: 'Sourdough Loaves', name: 'Olive & Rosemary Sourdough', desc: 'Briny Kalamata olives and fragrant rosemary woven through a naturally-leavened loaf. Mediterranean soul in every slice — extraordinary with olive oil.', prices: [{ label: 'Loaf', val: '₹400' }], emoji: '🫒', img: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=600&q=80' },
    { id: 'sd5', cat: 'sourdough', catLabel: 'Sourdough Loaves', name: 'Multiseed Sourdough', desc: 'A nutritious, hearty sourdough loaf generously seeded with sunflower, pumpkin, flax and sesame. Wonderfully nutty, with a crunchy crust and chewy interior.', prices: [{ label: 'Loaf', val: '₹400' }], emoji: '🌱', img: 'https://images.unsplash.com/photo-1600344852287-7253e05ad091?w=600&q=80' },

    // ITALIAN BREADS
    { id: 'ib1', cat: 'italian-breads', catLabel: 'Italian Breads', name: 'Ciabatta', desc: 'Rustic Italian bread with a crisp, lightly floured crust and an airy, open crumb. Delicate, chewy and perfect for sandwiches.', prices: [{ label: 'Per Piece', val: '₹140' }], emoji: '🥖', img: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&q=80' },
    { id: 'ib2', cat: 'italian-breads', catLabel: 'Italian Breads', name: 'Focaccia', desc: 'Infused with extra virgin olive oil, topped with heirloom cherry tomatoes, olives and rosemary, finished with a sprinkle of sea salt. Light, aromatic and vibrant.', prices: [{ label: 'Small', val: '₹250' }, { label: 'Large', val: '₹350' }], emoji: '🫒', img: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=600&q=80' },
    ...
    // SPECIALTY BREADS
    { id: 'sb1', cat: 'specialty-breads', catLabel: 'Specialty Breads', name: 'Brioche', desc: 'Rich buttery French bread with a tender, pillowy crumb and a delicate golden crust, subtly sweet, luxuriously soft, and beautifully versatile.', prices: [{ label: 'Loaf', val: '₹400' }], emoji: '🥐', img: 'https://images.unsplash.com/photo-1608198093002-ad4e005484ec?w=600&q=80' },
    { id: 'sb2', cat: 'specialty-breads', catLabel: 'Specialty Breads', name: 'Japanese Shokupan', desc: 'Japanese milk bread with an ultra-soft, cloud-like crumb and delicate sweetness. Tender, fluffy and beautifully light with a fine, velvety texture.', prices: [{ label: 'Loaf', val: '₹400' }], emoji: '🍞', img: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&q=80' },
    ...
    { id: 'vi3', cat: 'viennoiserie', catLabel: 'Viennoiserie', name: 'Cinnamon Roll', desc: 'Soft, buttery swirls layered with warm cinnamon sugar, baked until golden and finished with a delicate glaze. Cosy, fragrant, and deeply comforting.', prices: [{ label: 'Per Piece', val: '₹200' }], emoji: '🌀', img: 'assets/Cinnamon-Roll.jpg' },
    ...
    // SIGNATURE CAKES
    { id: 'sc1', cat: 'signature-cakes', catLabel: 'Signature Cakes', name: 'Lamington', desc: 'A classic Australian sponge cake dipped in rich chocolate and rolled in desiccated coconut, layered with a whipped cream filling. Light, soft and utterly irresistible.', prices: [{ label: 'Serves 6', val: '₹1,799' }, { label: 'Serves 10–12', val: '₹2,999' }], emoji: '🍰', img: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=600&q=80' },
    { id: 'sc2', cat: 'signature-cakes', catLabel: 'Signature Cakes', name: 'Dark Belgian Cake', desc: 'A show-stopping celebration cake built on layers of intensely dark Belgian chocolate sponge, rich ganache and silky chocolate cream. For true chocolate devotees.', prices: [{ label: 'Serves 6', val: '₹1,799' }, { label: 'Serves 10–12', val: '₹2,999' }], emoji: '🍫', img: 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=600&q=80' },
    { id: 'sc3', cat: 'signature-cakes', catLabel: 'Signature Cakes', name: 'Fresh Fruit Cake', desc: 'Layers of light vanilla sponge frosted with Chantilly cream and generously adorned with the season\'s freshest fruits. Elegant, fresh and naturally beautiful.', prices: [{ label: 'Serves 6', val: '₹1,599' }, { label: 'Serves 10–12', val: '₹2,599' }], emoji: '🍓', img: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&q=80' },
...
// ── WHATSAPP ──
function openWA(txt) {
    const msg = encodeURIComponent(`Hi The Tea Bake! ${txt}. Please let me know about availability. Thank you! 🙏`);
