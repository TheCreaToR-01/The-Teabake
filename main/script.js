...
const PRODUCTS = [
    ...
    { id: 'tc1', cat: 'our-icons', catLabel: 'Home Style Tea Cakes', name: 'Date & Fig Walnut', desc: 'A moist, rich and crunchy cake. Melange of Tender chopped dates, sundried figs and toasted walnuts. Wholesome and indulgent.', prices: [{ label: '½ Kg', val: '₹1,199' }, { label: '1 Kg', val: '₹1,999' }], emoji: '🍰', img: 'main/assets/Date and fig.JPG' },
    ...
    { id: 'tc8', cat: 'our-icons', catLabel: 'Home Style Tea Cakes', name: 'Lemon Ricotta Almond', desc: 'Made with almond flour for a tender crumb from ricotta and a brighty citrusy finish. This cake is perfect on its own simple, elegant and wholesome.', prices: [{ label: '½ Kg', val: '₹1,599' }, { label: '1 Kg', val: '₹2,899' }], emoji: '🍋', img: 'main/assets/Lemon-Ricotta.jpeg' },
    ...
    // SOURDOUGH
    { id: 'sd1', cat: 'sourdough', catLabel: 'Sourdough Loaves', name: 'Country', desc: 'Naturally leavened and slow-fermented for depth of flavor, with a crisp artisan crust and an open chewy crumb. Mildly tangy, wholesome and beautifully rustic.', prices: [{ label: 'Loaf', val: '₹350' }], emoji: '🍞', img: 'main/assets/Country-Sourdough.jpeg' },
    ...
    { id: 'sd3', cat: 'sourdough', catLabel: 'Sourdough Loaves', name: 'Jalapeño & Cheddar', desc: 'A bold, savory sourdough with pockets of melted cheddar and the gentle heat of jalapeño peppers throughout. An addictive combination — cheesy, spicy, tangy.', prices: [{ label: 'Loaf', val: '₹450' }], emoji: '🧀', img: 'main/assets/Jalapeno-Sourdough.jpeg' },
    { id: 'sd4', cat: 'sourdough', catLabel: 'Sourdough Loaves', name: 'Olive & Rosemary', desc: 'Briny  olives and fragrant rosemary woven through a naturally-leavened loaf. Mediterranean soul in every slice — extraordinary with olive oil.', prices: [{ label: 'Loaf', val: '₹420' }], emoji: '🫒', img: 'main/assets/Olive-Rosemary-Sourdough.jpeg' },
    { id: 'sd5', cat: 'sourdough', catLabel: 'Sourdough Loaves', name: 'Multiseed', desc: 'A nutritious, hearty sourdough loaf generously seeded with sunflower, chia, oats, pumpkin, flax and sesame. Wonderfully nutty, with a crunchy crust and chewy interior.', prices: [{ label: 'Loaf', val: '₹400' }], emoji: '🌱', img: 'main/assets/Multiseed-Sourdough.jpeg' },
    ...
    // ITALIAN BREADS
    { id: 'ib1', cat: 'italian-breads', catLabel: 'Italian Breads', name: 'Ciabatta', desc: 'Rustic Italian bread with a crisp, lightly floured crust and an airy, open crumb. Delicate, chewy and perfect for sandwiches.', prices: [{ label: 'Pack of 2', val: '₹280' }], emoji: '🥖', img: 'main/assets/Ciabatta.jpeg' },
    ...
    { id: 'vi4', cat: 'viennoiserie', catLabel: 'Viennoiserie', name: 'Maritozzo', desc: 'Soft, lightly sweetened brioche bun generously filled with airy whipped cream. Pillowy, delicate and irresistibly indulgent.', prices: [{ label: 'Per Piece', val: '₹250' }], emoji: '🍰', img: 'main/assets/Maritozzo.jpeg' },
    { id: 'vi5', cat: 'viennoiserie', catLabel: 'Viennoiserie', name: 'Bagel', desc: 'Hand-rolled and gently boiled before baking for its signature satisfying chew. Dense, chewy, golden — the real thing.', prices: [{ label: 'Pack of 2', val: '₹250' }], emoji: '🥯', img: 'main/assets/Bagel.jpeg' },
    ...
    { id: 'tm1', cat: 'house-classics', catLabel: 'Tarts, Tub Cakes & Mousse', name: 'Lemon Tart', desc: 'Crisp buttery tart shell filled with silky lemon custard. Bright, zesty, balanced with a smooth mascarpone cream. A study in perfect contrasts.', prices: [{ label: 'Per Piece', val: '₹299' }], emoji: '🍋', img: 'main/assets/Lemon-Tart.jpeg' },
    { id: 'tm2', cat: 'house-classics', catLabel: 'Tarts, Tub Cakes & Mousse', name: 'Fresh Fruit Tart', desc: 'Smooth vanilla custard crowned with an elegant selection of seasonal fresh fruits. Colourful, delicate, and as beautiful as it is delicious.', prices: [{ label: 'Per Piece', val: '₹299' }], emoji: '🍓', img: 'main/assets/Fresh-Fruit-Tart.jpeg' },
    { id: 'tm3', cat: 'house-classics', catLabel: 'Tarts, Tub Cakes & Mousse', name: 'Banoffee Pie', desc: 'Buttery biscuit base layered with rich caramel, fresh banana and light whipped cream. A British classic that never fails to delight.', prices: [{ label: 'Per Piece', val: '₹299' }], emoji: '🍌', img: 'main/assets/Banoffee.jpeg' },
    ...
    { id: 'sc1', cat: 'founder-favourites', catLabel: 'Signature Cakes', name: 'Lamington', desc: 'A classic Australian sponge cake dipped in rich chocolate and rolled in desiccated coconut, layered with raspberry compote and whipped vanilla cream filling.', prices: [{ label: 'Serves 6', val: '₹1,799' }, { label: 'Serves 10–12', val: '₹2,999' }], emoji: '🍰', img: 'main/assets/Lamington.jpeg' },
    ...
    { id: 'sc8', cat: 'founder-favourites', catLabel: 'Signature Cakes', name: 'Forêt Noire', desc: 'Decadent chocolate sponge layered with silky cream and luscious cherry compote, finished with dark chocolate shavings.', prices: [{ label: 'Serves 6', val: '₹1,699' }, { label: 'Serves 10–12', val: '₹2,799' }], emoji: '🍒', img: 'main/assets/Forest-Noire.jpeg' },
    { id: 'sc9', cat: 'founder-favourites', catLabel: 'Signature Cakes', name: 'Classic Vanilla Bean Cake', desc: 'A light yet satisfying soft, buttery loaf infused with pure Madagascar vanilla bean, topped with classic cream chantilly. Simple, elegant and made with love in every slice', prices: [{ label: 'Serves 6', val: '₹1,599' }, { label: 'Serves 10–12', val: '₹2,699' }], emoji: '🍦', img: 'main/assets/Vanilla-Bean.jpeg' },
    ...
    { id: 'sc12', cat: 'founder-favourites', catLabel: 'Signature Cakes', name: 'Tres Leches', desc: 'Light vanilla sponge soaked in a blend of three milks, finished with a cloud of whipped cream, pistachios and rose petals. Moist, delicate and beautifully indulgent — to share.', prices: [{ label: 'Per Piece', val: '₹350' }, { label: 'Serves 6', val: '₹1,800' }, { label: 'Serves 10–12', val: '₹3,099' }], emoji: '🌹', img: 'main/assets/Tres-leches.jpeg' },
];
const TESTIMONIALS = [
