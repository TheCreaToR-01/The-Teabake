...
const PRODUCTS = [
    ...
    // SOURDOUGH
    { id: 'sd1', cat: 'sourdough', catLabel: 'Sourdough Loaves', name: 'Country Sourdough', desc: 'Naturally leavened and slow-fermented for depth of flavor, with a crisp artisan crust and an open chewy crumb. Mildly tangy, wholesome and beautifully rustic.', prices: [{ label: 'Loaf', val: '₹350' }], emoji: '🍞', img: 'main/assets/Sourdough.jpeg' },
