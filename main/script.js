...
const PRODUCTS = [
    ...
    { id: 'sd4', cat: 'sourdough', catLabel: 'Sourdough Loaves', name: 'Olive & Rosemary Sourdough', desc: 'Briny Kalamata olives and fragrant rosemary woven through a naturally-leavened loaf. Mediterranean soul in every slice — extraordinary with olive oil.', prices: [{ label: 'Loaf', val: '₹400' }], emoji: '🫒', img: 'main/assets/Olive-Rosemary-Sourdough.jpg' },
    { id: 'sd5', cat: 'sourdough', catLabel: 'Sourdough Loaves', name: 'Multiseed Sourdough', desc: 'A nutritious, hearty sourdough loaf generously seeded with sunflower, pumpkin, flax and sesame. Wonderfully nutty, with a crunchy crust and chewy interior.', prices: [{ label: 'Loaf', val: '₹400' }], emoji: '🌱', img: 'main/assets/Multiseed-Sourdough.jpg' },
