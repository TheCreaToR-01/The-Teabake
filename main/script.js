...
const PRODUCTS = [
    ...
    { id: 'sc4', cat: 'founder-favourites', catLabel: 'Signature Cakes', name: 'Tropical Twist', desc: 'A vibrant tropical celebration cake with layers of mango, passionfruit and coconut finished with pineapple glaze and toasted coconut. Bright, sunny and deeply fragrant — a taste of the tropics in every bite.', prices: [{ label: 'Serves 6', val: '₹1,699' }, { label: 'Serves 10–12', val: '₹2,799' }], emoji: '🥭', img: 'main/assets/Tropical-Twist.jpeg' },
