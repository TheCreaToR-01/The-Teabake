...
const PRODUCTS = [
    ...
    { id: 'tc2', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Dark Chocolate Valencia', desc: 'Rich dark chocolate meets the bright fragrance of Valencia orange in this deeply indulgent loaf. Fudgy, intense, and just slightly bittersweet — a grown-up chocolate cake.', prices: [{ label: '½ Kg', val: '₹1,199' }, { label: '1 Kg', val: '₹1,999' }], emoji: '🍫', img: 'main/assets/Dark-Chocolate-Valencia.jpg', type: "main/assets/veg.png", tag: 'Bestseller ⭐ 5' },
    { id: 'tc3', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Lemon Ricotta Almond', desc: 'Made with almond flour for a tender crumb from ricotta and a brighty citrusy finish. This cake is perfect on its own simple, elegant and wholesome.', prices: [{ label: '½ Kg', val: '₹1,599' }, { label: '1 Kg', val: '₹2,899' }], emoji: '🍋', img: 'main/assets/Lemon-Ricotta.jpeg', type: "main/assets/veg.png" },
    ...
    { id: 'tc8', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: ' Coffee and Walnut Cake', desc: 'a moist coffee flavoured sponge with earthy crunch of walnuts , topped with rich brown butter cream cheese frosting.', prices: [{ label: '½ Kg', val: '₹1,599' }, { label: '1 Kg', val: '₹2,899' }], emoji: '🍌', img: 'main/assets/coffee-walnut-cake.jpeg', type: "main/assets/veg.png" },
    { id: 'tc9', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Carrot Walnut Cake', desc: 'Spiced carrot cake with warm cinnamon and hints of nutmeg, shredded carrots. Finished with a smooth cream cheese frosting and walnuts.', prices: [{ label: '½ Kg', val: '₹1,399' }, { label: '1 Kg', val: '₹2,799' }], emoji: '🥕', img: 'main/assets/Carrot-Cake.jpeg', type: "main/assets/veg.png", tag: "Seasonal" },
    ...
    { id: 'tc11', cat: 'tea-cakes', catLabel: 'Home Style Tea Cakes', name: 'Cakey Brownie - The Tea Bake Style', desc: "a lighter alternative to the traditional dense and fudgy brownie, featuring a texture more similar to a moist chocolate cake.", prices: [{ label: 'Set of 2', val: '₹399' }], emoji: '🎄', img: 'main/assets/brownie.jpeg', type: "main/assets/veg.png", tag: "Seasonal" },
    ...
    { id: 'sd6', cat: 'sourdough', catLabel: 'Sourdough Loaves', name: '100% Whole Wheat', desc: 'Pure whole wheat sourdough with a nutty flavour, wholesome crumb, and rustic character.', prices: [{ label: 'Loaf', val: '₹400' }], emoji: '🌱', img: 'main/assets/Whole-Wheat.jpeg', type: "main/assets/veg.png" },

    // ITALIAN BREADS
    { id: 'ib1', cat: 'italian-breads', catLabel: 'Italian Breads', name: 'Ciabatta', desc: 'Rustic Italian bread with a crisp, lightly floured crust and an airy, open crumb. Delicate, chewy and perfect for sandwiches.', prices: [{ label: 'Pack of 2', val: '₹280' }], emoji: '🥖', img: 'main/assets/Ciabatta.jpeg', type: "main/assets/vegan.png", tag: 'Bestseller ⭐ 5' },
    ...
    { id: 'sc9', cat: 'chef-favourites', catLabel: 'Signature Cakes', name: 'Vanilla Meringue Cake', desc: 'Layers of vanilla sponge cake filled with creamy custard and topped with fluffy meringue that’s lightly toasted for added flavour.', prices: [{ label: 'Serves 6', val: '₹1,999' }, { label: 'Serves 10–12', val: '₹3,499' }], emoji: '🍦', img: 'main/assets/Vanilla-Meringue-Cake.jpeg', type: "main/assets/veg.png", tag: 'Bestseller ⭐ 5' },
...
// ── WHATSAPP ──
function openWA(txt) {
    const msg = encodeURIComponent(`Hi! I’d like to place an order from The Tea Bake.`);
