...
const PRODUCTS = [
    ...
    { id: 'tm4', cat: 'tarts-mousse', catLabel: 'Tarts, Tub Cakes & Mousse', name: 'Tres Leches', desc: 'Light vanilla sponge soaked in a blend of three milks, finished with a cloud of whipped cream, dusted with finely chopped pistachios and rose petals. Moist, delicate and beautifully indulgent.', prices: [{ label: 'Per Piece', val: '₹350' }], emoji: '🌹', img: 'main/assets/Tres-leches.jpeg' },
    { id: 'tm5', cat: 'tarts-mousse', catLabel: 'Tarts, Tub Cakes & Mousse', name: 'Trifle', desc: 'Layers of soft sponge, fresh fruit, silky custard and luscious whipped cream. Delicately assembled for a dessert that is vibrant and creamy in every spoonful.', prices: [{ label: 'Per Piece', val: '₹350' }], emoji: '🍮', img: 'main/assets/Triffle.jpeg' },
    { id: 'tm6', cat: 'tarts-mousse', catLabel: 'Tarts, Tub Cakes & Mousse', name: 'Belgian Chocolate Mousse', desc: 'Silky, airy mousse crafted with fine Belgian chocolate with a dollop of rich French cream. Pure, unapologetic chocolate indulgence.', prices: [{ label: 'Per Piece', val: '₹250' }], emoji: '🍫', img: 'main/assets/Belgian-Chocolate-Mousse.jpeg' },
