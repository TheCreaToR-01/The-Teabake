...
const PRODUCTS = [
    ...
    // ITALIAN BREADS
    { id: 'ib1', cat: 'italian-breads', catLabel: 'Italian Breads', name: 'Ciabatta', desc: 'Rustic Italian bread with a crisp, lightly floured crust and an airy, open crumb. Delicate, chewy and perfect for sandwiches.', prices: [{ label: 'Pack of 2', val: '₹280' }], emoji: '🥖', img: 'main/assets/Ciabatta.jpeg', type: "main/assets/vegan.png", tag: 'Bestseller' },
